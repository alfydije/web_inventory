...
/*kuen kuh vida pas diganti database postgree, kien kita mah durung diganti database postgree masih sql, oh berarti ora ke migrate 
kaya e asset web_logo, terus carae priwe*/
